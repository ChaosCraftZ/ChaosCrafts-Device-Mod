package net.chaoscraft.chaoscrafts_device_mod.Core.PC.item.custom;

import net.chaoscraft.chaoscrafts_device_mod.Core.PC.item.client.LaptopItemRenderer;
...
public class LaptopItem extends BlockItem implements GeoItem {
    ...
    private PlayState predicate(AnimationState<GeoAnimatable> geoAnimatableAnimationState) {
        geoAnimatableAnimationState.getController().setAnimation(RawAnimation.begin().then("animation.laptop.idle", Animation.LoopType.LOOP));
