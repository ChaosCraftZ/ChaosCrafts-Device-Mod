...
public class LaptopShapeHelper {
    ...
    // Bone names from the geometry file
    private static final String BONE_TOP_BASE = "top_base";
    private static final String BONE_SCREEN = "screen";
    private static final String BONE_BOTTOM_BASE = "bottom_base";

    // Pivot points from the geometry file
    private static final double ROOT_PIVOT_X = 0.5;
    private static final double ROOT_PIVOT_Y = 1.75 / 16.0;
    private static final double ROOT_PIVOT_Z = 7.5 / 16.0;
