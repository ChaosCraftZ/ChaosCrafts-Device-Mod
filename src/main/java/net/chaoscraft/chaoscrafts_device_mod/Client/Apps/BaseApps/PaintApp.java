...
public class PaintApp implements IApp {
    ...
    private static final Logger LOGGER = LogManager.getLogger(PaintApp.class);

    @Override
    public void onOpen(DraggableWindow window) {
        this.font = Minecraft.getInstance().font;
        this.hexColorInput = new EditBox(this.font != null ? this.font : Minecraft.getInstance().font, 0, 0, 80, 16, Component.literal("HEX"));
    ...
    guiGraphics.drawString(this.font != null ? this.font : Minecraft.getInstance().font, Component.literal("Clear"), cx + 12, cy + 10, 0xFFFFFFFF, false);

    // Save button
    guiGraphics.fill(cx + 62, cy + 6, cx + 122, cy + 26, 0xFF555555);
    guiGraphics.drawString(this.font != null ? this.font : Minecraft.getInstance().font, Component.literal("Save PNG"), cx + 68, cy + 10, 0xFFFFFFFF, false);

    // Brush size indicator
    guiGraphics.fill(cx + 128, cy + 6, cx + 148, cy + 26, 0xFF555555);
    guiGraphics.drawString(this.font != null ? this.font : Minecraft.getInstance().font, Component.literal("" + brushSize), cx + 134, cy + 10, 0xFFFFFFFF, false);

        // Brush size controls
    guiGraphics.fill(cx + 154, cy + 6, cx + 174, cy + 20, 0xFF666666);
    guiGraphics.drawString(this.font != null ? this.font : Minecraft.getInstance().font, Component.literal("+"), cx + 160, cy + 8, 0xFFFFFFFF, false);

    guiGraphics.fill(cx + 154, cy + 12, cx + 174, cy + 26, 0xFF666666);
    guiGraphics.drawString(this.font != null ? this.font : Minecraft.getInstance().font, Component.literal("-"), cx + 160, cy + 14, 0xFFFFFFFF, false);
    ...
    guiGraphics.drawString(this.font != null ? this.font : Minecraft.getInstance().font, Component.literal("Colors"), colorPickerBtnX + 8, cy + 10, 0xFFFFFFFF, false);
    ...
    guiGraphics.drawString(this.font != null ? this.font : Minecraft.getInstance().font, Component.literal("OK"), pickerX + pickerW - 40, pickerY + pickerH - 20, 0xFFFFFFFF, false);
    }
    ...
    private void exportPNG(DraggableWindow window) {
        asyncRuntime.submitIo(() -> {
            try {
                ...
                FilesManager.getInstance().saveImageAsWallpaper(img, "paint_export");

                // Play sound on main thread and log
                ...
                LOGGER.warn("Failed to export PNG in PaintApp", e);
            }
        });
    }
