...
public class NotesApp implements IApp {
    ...
    public void onOpen(DraggableWindow window) {
        ...
        this.noteTitleInput = new EditBox(this.font != null ? this.font : Minecraft.getInstance().font, 0, 0, 200, 16, Component.literal("Title"));
        this.noteContentInput = new MultiLineEditor(this.font != null ? this.font : Minecraft.getInstance().font);
